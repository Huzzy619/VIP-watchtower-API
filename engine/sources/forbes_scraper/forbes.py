...
class ForbesVip():
    ...
    def process(self, search_query: dict):
        """
        ...
        for i in range(len):
            ...
            diction = {
                ...
                "gender": gender,
                "vip_score": vip_score,
                "networth": worth * 10**6   # 10^6 needs to be added to get the actual value from forbes
            }
            # compile name passed to regex pattern
            namep = re.compile(search_query['name'].lower())
